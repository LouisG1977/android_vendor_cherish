...
SOONG_CONFIG_cherishGlobalVars += force_build_fingerprint
endif
...
SOONG_CONFIG_cherishGlobalVars_target_surfaceflinger_fod_lib := $(TARGET_SURFACEFLINGER_FOD_LIB)
...
ifneq ($(TARGET_FORCE_BUILD_FINGERPRINT),)
SOONG_CONFIG_cherishGlobalVars_force_build_fingerprint := $(TARGET_FORCE_BUILD_FINGERPRINT)
endif
